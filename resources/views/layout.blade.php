...
<body>
    <div id="wrapper">
        ...
        <div class="sidebar">
            ...
            <p class="brand-title"><a class="" style="color: #fe53bb;" href="">LATEST STORIES..</a></p>
                ...
                <ul>
                    ...
                    @auth
                        <li><a class="{{ Request::routeIs('dashboard') ? 'active' : '' }}"
                                href="{{ route('dashboard') }}">Create story</a></li>
                    @endauth
                </ul>
            </div>
            ...
            <footer class="sidebar-footer">
                ...
                <small>&copy 2022 News Stream Blog</small>
            </footer>
        </div>
        <!-- Menu Button -->
        ...
        <footer class="main-footer">
            ...
            <p>Copyright &copy; 2022 News Stream Blog. All Rights Reserved.</p>
            <small>Irvine kwambana @BluFare Software.</small>
        </footer>
    </div>
